var FIREBASE_URL = 'https://c9authdemoo.firebaseio.com/';
var fb = new Firebase(FIREBASE_URL);

$('.passwordChange').click(function() {
  var onChangePassword = $('.onChangePassword');
  var onLoggedIn = $('.onLoggedIn');
  onChangePassword.removeClass('hidden');
  onLoggedIn.addClass('hidden');
});
$('.emailChange').click(function() {
    var onChangeEmail = $('.onChangeEmail');
    var onLoggedIn = $('.onLoggedIn');
    onChangeEmail.removeClass('hidden');
    onLoggedIn.addClass('hidden');
});
